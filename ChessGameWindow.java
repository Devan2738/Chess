		...
		for (int i = 0; i < dimension; i++){
			for (int j = 0; j < dimension; j++, count++){
				...
				if (board.get(i, j).getChar() == 'r') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\blackCastle.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'n') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\blackKnight.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'b') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\blackBishop.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'q') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\blackQueen.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'k') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\blackKing.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'p') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\blackPawn.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'R') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\whiteCastle.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'N') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\whiteKnight.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'B') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\whiteBishop.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'Q') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\whiteQueen.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'K') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\whiteKing.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'P') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\pieces\\whitePawn.png");
					newButton.setIcon(icon);
				}
				else {
