		...
		for (int i = 0; i < dimension; i++){
			for (int j = 0; j < dimension; j++, count++){
				...
				if (board.get(i, j).getChar() == 'r') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\blackCastle.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'n') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\blackKnight.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'b') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\blackBishop.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'q') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\blackQueen.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'k') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\blackKing.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'p') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\blackPawn.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'R') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\whiteCastle.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'N') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\whiteKnight.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'B') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\whiteBishop.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'Q') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\whiteQueen.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'K') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\whiteKing.png");
					newButton.setIcon(icon);
				}
				else if (board.get(i, j).getChar() == 'P') {
					ImageIcon icon = new ImageIcon("C:\\Users\\Devan\\eclipse-workspace\\Chess (UvAI) 1 GUI\\whitePawn.png");
					newButton.setIcon(icon);
				}
				else {
