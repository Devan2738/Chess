...
public class King implements ChessPiece{
	...
	public void generateTakeOpponentPieceMoves(ChessBoard board) {
		...
		if (color.equals("white")) {
           ...
           if (startRow - 1 > -1)
		      if (board.get(startRow-1, startColumn).getColor().equals("black"))
		          takeOpponentPieceMoves.add(new MoveCommand(startRow, startColumn, startRow-1, startColumn));
           ...
           if (startColumn + 1 < 8)
			  if (board.get(startRow, startColumn+1).getColor().equals("black"))
			     takeOpponentPieceMoves.add(new MoveCommand(startRow, startColumn, startRow, startColumn+1));
